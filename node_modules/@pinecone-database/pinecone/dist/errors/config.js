...
var PineconeUnknownRequestFailure = /** @class */ (function (_super) {
    __extends(PineconeUnknownRequestFailure, _super);
    function PineconeUnknownRequestFailure(url, underlyingError) {
        var _this = this;
        var message = "Something went wrong while attempting to call ".concat(url, ". Please check your configuration and try again later. Underlying error was ").concat(JSON.stringify(underlyingError));
        _this = _super.call(this, message) || this;
        _this.name = 'PineconeUnknownRequestFailure';
        return _this;
    }
    return PineconeUnknownRequestFailure;
}(base_1.BasePineconeError));
